...
from gui_freqlex import fenetre_freqlex,LARGEUR_CADRE_ENONCE
...
class Licence:
    def __init__(self,appli):
        ...
        ##Boutons
        bouton_refuse=Button(fenetre,text="Je refuse cette licence.",command=self.refuser)
        bouton_accepte=Button(fenetre,text="J'accepte cette licence.",command=self.accepter)
        bouton_questionnaire=Button(fenetre,text="J'accepte cette licence et je soutiens ce projet en remplissant un questionnaire.",command=self.questionnaire)
